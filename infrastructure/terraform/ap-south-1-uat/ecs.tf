  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        # ── Database & Cache ──────────────────────────────────────────────
        { name = "MONGO_URI",  value = "mongodb://aidocsuser:${random_password.docdb_master.result}@${aws_docdb_cluster.docdb.endpoint}:27017/ai-docs-summarizer?replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" },
